        ...
        <div className='card-container'>
          <Card style={{ width: '35rem' }}>
            <Card.Body className="mb-3">
              ...
              <Card.Text>
                School Name: {oneTeam.school} <br />
                Mascot: {oneTeam.name} <br />
  ...
  return (
    <div className="App">
      <header className="App-header">
        <Welcome></Welcome>   
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Duke_Athletics_logo.svg/225px-Duke_Athletics_logo.svg.png" className="App-logo" alt="logo" />
        <TeamList/>
